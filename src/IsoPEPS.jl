...
- `using CairoMakie` → plotting functions (plot_training_history, plot_correlation_function, etc.)
- `using LsqFit` → ACF fitting (corr_exp_fit, fit_acf_oscillatory)
...
function compute_sampling_structure_factor_dmrg end
function compute_M2_dmrg end
function compute_dimer_structure_factor_dmrg end
function compute_sampling_dimer_structure_factor_dmrg end
function compute_dimer_order_squared_dmrg end
...
export compute_spin_spin_correlation_dmrg, compute_structure_factor_dmrg
export compute_sampling_structure_factor_dmrg, compute_M2_dmrg
export compute_dimer_structure_factor_dmrg, compute_sampling_dimer_structure_factor_dmrg
export compute_dimer_order_squared_dmrg, compute_plaquette_structure_factor_dmrg
...
export compute_tfim_energy_vs_g_data, load_tfim_energy_vs_g_data
export compute_tfim_energy_vs_g_error_data, load_tfim_energy_vs_g_error_data
export plot_tfim_energy_vs_g_from_processed_data, plot_tfim_energy_vs_g_error_from_processed_data
export compute_heisenberg_energy_vs_J2_data, load_heisenberg_energy_vs_J2_data
export plot_heisenberg_energy_vs_J2_from_processed_data
export compute_tfim_energy_dynamics_data, load_tfim_energy_dynamics_data
export plot_tfim_energy_dynamics_from_processed_data
export compute_tfim_correlation_length_vs_g_data, load_tfim_correlation_length_vs_g_data
export plot_tfim_correlation_length_from_processed_data
export compute_tfim_observables_vs_g_data
export load_tfim_connected_correlation_vs_g_data, load_tfim_magnetization_vs_g_data
export plot_tfim_connected_correlation_from_processed_data, plot_tfim_magnetization_from_processed_data
export plot_connected_corr_vs_g, plot_magnetization_vs_g
export compute_training_history_data, load_training_history_data
export plot_training_history_from_processed_data
export save_M2_vs_J2, plot_M2_comparison
export plot_dimer_structure_factor, plot_spin_structure_factor, plot_combined_structure_factors, save_combined_structure_factor_data
export plot_bond_energy_pattern, compute_bond_energy_pattern_data, load_bond_energy_pattern_data
export plot_bond_energy_pattern_from_processed_data, plot_energy_dynamics_vs_g, plot_local_xz_dynamics_vs_g
